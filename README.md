...
**0.4.2 — pending hardware validation**.
...
opkg install /tmp/enigma2-plugin-extensions-tkgs-navigator_0.4.2_all.ipk

# Python 3 images using dpkg
dpkg -i /tmp/enigma2-plugin-extensions-tkgs-navigator_0.4.2_all.deb
```
